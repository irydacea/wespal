...
const BuiltinColorRanges builtinColorRanges = {
	// Unit TC
	{ "red",			tr("Red"),				{ 0xFF0000, 0xFFFFFF, 0x000000 } },
	{ "blue",			tr("Blue"),				{ 0x2E419B, 0xFFFFFF, 0x0F0F0F } },
	{ "green",			tr("Green"),			{ 0x62B664, 0xFFFFFF, 0x000000 } },
	{ "purple",			tr("Purple"),			{ 0x93009D, 0xFFFFFF, 0x000000 } },
	{ "black",			tr("Black"),			{ 0x5A5A5A, 0xFFFFFF, 0x000000 } },
	{ "brown",			tr("Brown"),			{ 0x945027, 0xFFFFFF, 0x000000 } },
	{ "orange",			tr("Orange"),			{ 0xFF7E00, 0xFFFFFF, 0x0F0F0F } },
	{ "white",			tr("White"),			{ 0xE1E1E1, 0xFFFFFF, 0x1E1E1E } },
	{ "teal",			tr("Teal"),				{ 0x30CBC0, 0xFFFFFF, 0x000000 } },
	{ "lightred",		tr("Light Red"),		{ 0xD1620D, 0xFFFFFF, 0x000000 } },
	{ "darkred",		tr("Dark Red"),			{ 0x8A0808, 0xFFFFFF, 0x000000 } },
	{ "lightblue",		tr("Light Blue"),		{ 0x00A4FF, 0xFFFFFF, 0x000A21 } },
	{ "brightgreen",	tr("Bright Green"),		{ 0x8CFF00, 0xEBFFBF, 0x2D4001 } },
	{ "brightorange",	tr("Bright Orange"),	{ 0xFFC600, 0xFFF7E6, 0x792A00 } },
	{ "gold",			tr("Gold"),				{ 0xFFF35A, 0xFFF8D2, 0x994F13 } },
#if 0
	// Terrain icon color ranges
	{ "reef",			tr("Reef"),				{ 0x00B6E3, 0x09FFDB, 0x00090D } },
	{ "shallow_water",	tr("Shallow Water"),	{ 0x027CC4, 0x00FFE7, 0x00223F } },
	{ "deep_water",		tr("Deep Water"),		{ 0x00419E, 0x5CD6FF, 0x000B15 } },
	{ "swamp_water",	tr("Swamp Water"),		{ 0x33978C, 0x38FF8B, 0x092A1E } },
	{ "flat",			tr("Flat"),				{ 0x89C236, 0xD9FF62, 0x023B02 } },
	{ "hills",			tr("Hills"),			{ 0xC0B030, 0xFBFF95, 0x353B00 } },
	{ "mountains",		tr("Mountains"),		{ 0x916B09, 0xE9DA7D, 0x3B3406 } },
	{ "forest",			tr("Forest"),			{ 0x263E01, 0x69B70A, 0x142303 } },
	{ "sand",			tr("Sand"),				{ 0xF1CE6C, 0xFFFCC0, 0x4A3212 } },
	{ "frozen",			tr("Frozen"),			{ 0x95B5E6, 0xFFF6BD, 0x180E5F } },
	{ "cave",			tr("Cave"),				{ 0x5A517D, 0xBBA1FF, 0x0A0616 } },
	{ "fungus",			tr("Fungus"),			{ 0x703816, 0xFB8435, 0x2B150B } },
	{ "village",		tr("Village"),			{ 0x995B51, 0xFFE0DB, 0x24190F } },
	{ "castle",			tr("Castle"),			{ 0x988C85, 0xFFF0E1, 0x171514 } },
	{ "keep",			tr("Keep"),				{ 0x6E6059, 0xFFF0E1, 0x171514 } },
	{ "rails",			tr("Rails"),			{ 0x4C5E6E, 0xFFFFFF, 0x181E24 } },
	{ "unwalkable",		tr("Unwalkable"),		{ 0xBD001F, 0xFF1D29, 0x240506 } },
	{ "impassable",		tr("Impassable"),		{ 0x7D0013, 0xD81721, 0x240506 } },
	{ "fog",			tr("Fog"),				{ 0x686868, 0xFFFFFF, 0x000000 } },
	{ "shroud",			tr("Shroud"),			{ 0x313131, 0x7E7E7E, 0x000000 } },
#endif
};
